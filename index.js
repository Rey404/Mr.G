...
//
const BotName = 'BOT Mr.741L'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/mr.rey404/'; // Nama Instagramlu cok
const whatsapplu = '089677763976'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'wa.me/6289677763976'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/K93vpSOh6uL7d4yJzSRh74'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.sendMessage(id, 'Kalo sepi bisa ditemani sama Abang Rey 😊 ketik #help untuk memunculkan menu bot' ,MessageType.text);
}
else if (text == 'halo'){
conn.sendMessage(id, 'Ya?, ada yang bisa saya bantu? kalo bingung ketik #help ya say..' ,MessageType.text);
}
